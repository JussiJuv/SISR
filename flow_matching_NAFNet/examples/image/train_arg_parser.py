...
def get_args_parser():
    ...
    parser.add_argument(
        "--warm_start_lr",
        action="store_true",
        help="Use LR as the starting state x0 instead of Gaussian noise.",
    )
    ...
    parser.add_argument(
        ...
        default="pixel",
        help="Train flow matching in pixel space or latent space.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to the pretrained latent autoencoder checkpoint. Required when --space_mode latent.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to saved latent mean/std statistics. Required when using latent space.",
    )
    ...
    parser.add_argument("--num_val_images",
                        type=int,
                        default=1,
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="Print training logs every N iterations",
    )
    ...
    parser.add_argument(
        "--lr_data_path",
        type=str,
        help="Path to the low-res DIV2K folder"
    )
    parser.add_argument(
        "--data_path",
    ...
    parser.add_argument("--save_inference_only", action="store_true", help="Only save model state and args to save disk space (cannot resume training from these).")
    ...
    parser.add_argument("--save_frequency", default=1, type=int, help="Save checkpoint every N epochs")
    parser.add_argument(
        "--compute_fid",
        action="store_true",
